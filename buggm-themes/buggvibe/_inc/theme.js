   ...
   function equalHeights(columns){  
	...
	j(document).ready(function() {  
           ...
           j("#toggle-comments").toggle(function(){
               ...
               j("#ticket-comment-list").hide();

           },function(){
               j("#ticket-comment-list").show();
                j(this).removeClass('comment-toggled');
           });

		 equalHeights(j("#featured-footer-top div.col"));  
		 equalHeights(j("#featured-footer-bottom div.col")); 
		
                //for the siidebar and the content
                var sidebar=j("#sidebar");
                if(sidebar.get(0)&&sidebar.css('display')!='none'){
                    var s_height=sidebar.height();
                    var content_height=j("#content").height();
                    var max=s_height>content_height?s_height:content_height;
                    j("#sidebar").height(max);
                    j("#content").height(max);
...
arrowimages: {down:['downarrowclass', buggvibe.menu_down_icon, 28], right:['rightarrowclass', buggvibe.menu_right_icon]},
...
buildmenu:function($, setting){
	...
	if (smoothmenu.shadow.enable && smoothmenu.css3support){ //if shadows enabled and browser supports CSS3 shadows
		...
		var css3shadow=parseInt(smoothmenu.shadow.offsetx)+"px "+parseInt(smoothmenu.shadow.offsety)+"px 0px #282623" //construct CSS3 box-shadow value
...
//the Dynamic Drive Smoothe Menu 	
ddsmoothmenu.init({
...
// I promise to remove this dd in next version
  });  
